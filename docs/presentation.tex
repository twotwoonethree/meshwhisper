...
\begin{center}
  ...
  {\color{mwlight}\small GestureLoop Ltd · meshwhisper.net · April 2026}
\end{center}
\end{frame}
}
...
\begin{center}
  ...
  \begin{tabular}{ll}
    ...
    \color{mwbright}\textbf{Docs}    & \color{white}\texttt{meshwhisper.net} \\[4pt]
    \color{mwbright}\textbf{Demo}    & \color{white}\texttt{prudence.meshwhisper.net} \\[4pt]
    \color{mwbright}\textbf{Contact} & \color{white}\texttt{anton@gestureloop.com} \\
  \end{tabular}\\[14pt]
  \color{mwbright}\rule{80mm}{0.4pt}\\[8pt]
  {\color{mwlight}\small MIT licensed · Self-hosting always free · GestureLoop Ltd, Ireland}
\end{center}
\end{frame}
}
