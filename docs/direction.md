...
- **Documentation** — [API reference](api.md), [Identity patterns](identity-patterns.md), [Identifier patterns](identifier-patterns.md), [Multi-device](multi-device.md), [Federation](federation.md), [Self-hosting](self-hosting.md), [Architecture decisions](adr/), [Codebase overview](codebase-overview.md), and the [Whitepaper](whitepaper.md).
